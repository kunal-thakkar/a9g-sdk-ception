...
# installed.
TCL_PREFIX='/arm-insight'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/arm-insight'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/cygdrive/e/GDB_WORK/insight-6.8-1a/tcl/win -ltcl84'
...
TCL_INCLUDE_SPEC='-I/arm-insight/include'
...
# compiled.
TCL_SRC_DIR='/cygdrive/e/GDB_WORK/insight-6.8-1a/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/cygdrive/e/GDB_WORK/insight-6.8-1a/tcl/win -ltclstub84'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/arm-insight/lib -ltclstub84'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/cygdrive/e/GDB_WORK/insight-6.8-1a/tcl/win/libtclstub84.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/arm-insight/lib/libtclstub84.a'
