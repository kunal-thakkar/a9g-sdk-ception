...
# installed.
TK_PREFIX='/arm-insight'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/arm-insight'

# -I switch(es) to use to make all of the X11 include files accessible:
TK_XINCLUDES='-I"/cygdrive/e/GDB_WORK/insight-6.8-1a/tk/xlib"'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/cygdrive/e/GDB_WORK/insight-6.8-1a/tk/win -ltk84'
...
# compiled.
TK_SRC_DIR='/cygdrive/e/GDB_WORK/insight-6.8-1a/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/cygdrive/e/GDB_WORK/insight-6.8-1a/tk/win -ltkstub84'
